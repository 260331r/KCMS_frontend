...
function generate_place_list() {
    ...
    const sec = document.querySelector('#place_select_box');
...
function give_button() {
    ...
    button.onclick= async function() {
        const select_value = fetch_value();
        const searched_elements = await db_search_elements(select_value);
        // 別ページへオブジェクトを渡すための処理
